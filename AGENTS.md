...
Use this file as a Brain-managed project context entrypoint for `DwemerForge`.
...
5. Retrieve project memory with `brain find dwemerforge` or `brain search "dwemerforge <task>"` when the compiled packet is not enough.
